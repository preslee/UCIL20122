...
class getFeedbackOnFeatureSelection:
    ...
    def printFeedback(self, WidgetObject):
        if 'Height' in WidgetObject.getFeatureValues():
            ...
            print("\N{Cross Mark} You missed the height feature. Normally, ballet dancers are taller than rugby players.")
        ...
        if 'Weight' in WidgetObject.getFeatureValues():
            ...
            print("\N{Cross Mark} You missed the weight feature. On average an England rugby player weights 105 kg whereas normally a ballet dancer does't weight more than 60 kg.")
        ...
        if 'Sex' in WidgetObject.getFeatureValues():
            print("\N{Cross Mark} Even though in our data the majority of rugby players are men and most of the ballet dancers are women, it's not fair to assume that the gender is distinguishing as both men and women can practice each of these activities.")
